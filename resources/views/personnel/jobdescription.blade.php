...
@section('content')
                        ...
                        <div class="card">
                            ...
                            <div>
                                        <table class="table  table-striped table-bordered table-hover table-advance dataTable no-footer" id="editable_table" role="grid">
                                            ...
                                            <tbody>
                                            @foreach($jobdesc as $jobdescs) 
                                                <tr role="row" class="even">

                                                    <td>{{ $jobdescs -> JobDescriptionID }}</td>
                                                    <td>{{ $jobdescs -> JobDescription }}</td>
                                                    <td>
                                                        <!--EDIT BUTTON-->
    ...
    {!! Form::open(array('id' => 'addForm', 'url' => 'jobdescription', 'action' => 'JobDescriptionController@store', 'method' => 'POST')) !!}
                    ...
                    <div class="modal-body">
                        <div class="column">
                            <div class="col-md-12">
                                ...
                                {!!
                                    Form::input
                                    ('name','text', Input::old('jobdescription'), [
                                    'id'=>'jobdescription',
                                    'name'=>'jobdescription',
                                    'type'=>'text',
